package com.openglproject.android;

import static android.opengl.GLES20.*;

public class TextureShaderProgram extends LightingShaderProgram {

	static String texVertexShader = 
...
+ 	"}";
	...
	static String texFragmentShader = 
...
+	"}";
	...
	public TextureShaderProgram() {
		super(texVertexShader, texFragmentShader);
	...
	public void setUniform(Matrix4f world, Matrix4f WVP, int texID) {
		...
		glUniform1i(uTexUnitLocation, texID);
	}
